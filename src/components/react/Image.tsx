...
export default function Image({ src, alt, caption }: Props) {
  return (
    <figure style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0.25em 0', maxWidth: '100%', minWidth: 0 }}>
      <img src={src} alt={alt ?? ''} style={{ width: '100%', maxWidth: '100%', height: 'auto' }} />
      {caption && (
