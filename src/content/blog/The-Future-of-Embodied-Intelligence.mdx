...
When a human-facing view is genuinely useful, the recommended path is to ask the agent itself to generate a GUI dashboard — for example, using [Streamlit](https://streamlit.io) via the PUDA CLI. Human UIs become derived artifacts of the agent-native platform, not a parallel stack to maintain.
